...
(setq straight-check-for-modifications 'live) ;; Gives massive speed up to startup time!
...
#+BEGIN_SRC elisp
(use-package consult
  :commands (execute-extended-command consult-imenu find-file consult-theme persp-switch-to-buffer* consult-ripgrep consult-line)
  :general ("C-s" 'consult-line)
  (jl/SPC-keys
...
(use-package dashboard
  ...
  (defun buffer-visit-dashboard ()
    (interactive)counsel-projectile-switch-project-by-name
...
(defun jl/org-font-setup ()
  (dolist (face '((org-document-title . 1.5)
    ...
    (set-face-attribute (car face) nil :family jl/text-font :weight 'regular :height (cdr face))
...
(use-package elfeed
  ...
  (jl/SPC-keys
    "are" 'elfeed)
  :custom
  (elfeed-feeds '(("https://golem.ph.utexas.edu/category/atom10.xml" mathematics)
        	  ...
        	  ("https://jeslie0.github.io/rss.xml" mathematics)
                  ("https://www.mohabatmath.ca/feed.xml" mathematics)
        	  ("https://xkcd.com/atom.xml" webcomic)
                  ("https://mmhaskell.com/blog/atom.xml" haskell)
