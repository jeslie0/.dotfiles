...
* .stowrc
:PROPERTIES:
:header-args:conf: :tangle ./.stowrc
:END:
#+begin_src conf
--ignore ./.stowrc
--ignore ./ReadMe.org
...
# Status Bar: update when waybar and sway are both updated.
# bar {
...
bindsym Ctrl+$mod+p exec 'passmenu'
...
*** gaps
:PROPERTIES:
:header-args:conf: :tangle ./.config/sway/gaps
:END:
#+begin_src conf
# Gaps
...
*** style.css
:PROPERTIES:
:header-args:conf: :tangle ./.config/waybar/style.css
:END:
#+begin_src css
{
    border: none;
...
*** flake.nix
:PROPERTIES:
:header-args:nix: :tangle ./.config/Nix/flake.nix
:END:
*** configuration.nix
:PROPERTIES:
:header-args:nix: :tangle ./.config/Nix/configuration.nix
:END:
*** home.nix
:PROPERTIES:
:header-args:nix: :tangle ./.config/Nix/home.nix
:END:
