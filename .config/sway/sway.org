...
# Swaylock
bindsym Ctrl+Mod4+Delete exec "swaylock \
	--screenshots \
	--clock \
	--indicator \
...
bindsym Ctrl+Mod4+e exec 'emacsclient --create-frame --alternate-editor=""'
bindsym Ctrl+Mod4+f exec 'firefox'
...
#+end_src
* Partial screenshot
#+begin_src bash :tangle ./partialScreenshot.sh
#!/bin/bash
grim -g "$(slurp)" ~/Images/Screenshots/`date +%Y-%m-%d_%H:%M:%S`.png
#+end_src
* Swayfocus
#+begin_src haskell :tangle ./swayfocus.hs
import           Data.Char
import           Data.List
...
#+end_src
* Swaylock
#+begin_src bash :tangle ./swaylock.sh
#!/bin/bash
swaylock \
	--screenshots \
	--clock \
